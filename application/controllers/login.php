    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $this->email->message("
            ...
            <body>
                ...
                <br><br>
                <p><b>Password Baru</b>: <b>{$passwordbaru}</b></p>
                <p>Anda dapat login kembali dengan password baru Anda <a href=\"" . base_url() . "\" target=\"_blank\" style=\"text-decoration:none;font-weight:bold;\">disini</a>.</p>
            </body>
            </html>
        ");

        // Send email and update password in database
        if ($this->email->send()) {
